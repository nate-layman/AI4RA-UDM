...
('P001', NULL, 14, 'jane.smith@stateuniversity.edu', TRUE),
('P001', NULL, 15, '555-0101', FALSE),
('P001', NULL, 17, '555-0151', FALSE),
('P002', NULL, 14, 'john.doe@stateuniversity.edu', TRUE),
('P002', NULL, 15, '555-0102', FALSE),
('P003', NULL, 14, 'maria.garcia@stateuniversity.edu', TRUE),
('P003', NULL, 15, '555-0103', FALSE),
('P004', NULL, 14, 'david.chen@stateuniversity.edu', TRUE),
('P004', NULL, 15, '555-0104', FALSE),
('P009', NULL, 14, 'linda.martinez@stateuniversity.edu', TRUE),
('P009', NULL, 15, '555-0109', FALSE),
(NULL, 'SPON001', 14, 'grants@nih.gov', TRUE),
(NULL, 'SPON001', 15, '301-496-4000', TRUE),
(NULL, 'SPON001', 16, '301-496-9000', FALSE),
(NULL, 'SPON002', 14, 'info@nsf.gov', TRUE),
(NULL, 'SPON002', 15, '703-292-5111', TRUE),
(NULL, 'SPON003', 14, 'research@dod.mil', TRUE),
(NULL, 'SUBRE001', 14, 'contracts@techresearch.org', TRUE),
(NULL, 'SUBRE001', 15, '555-0201', FALSE);
